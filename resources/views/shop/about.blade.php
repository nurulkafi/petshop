...
@section('content')  
  ...
  <div id="content"> 
    ...
    <section class="cultur-block">
      <ul>
        <li> <img src="{{asset('shop/images/cultur-img-1.jpg')}}" alt="" > </li>
        <li> <img src="{{asset('shop/images/cultur-img-1.jpg')}}" alt="" > </li>
        <li> <img src="{{asset('shop/images/cultur-img-1.jpg')}}" alt="" > </li>
        <li> <img src="{{asset('shop/images/cultur-img-1.jpg')}}" alt="" > </li>
      </ul>
    ...
    <!-- Video -->
    <section class="video-block"> <img class="img-responsive" src="{{asset('shop/images/video-img.jpg')}}" alt="" >
      ...
      <div class="container">
        ...
        <ul class="row">
          ...
          <li class="col-md-4 text-center animate fadeInUp" data-wow-delay="0.4s">
            <article> 
              <!-- abatar -->
              <div class="avatar"> <img class="img-circle" src="{{asset('shop/images/team-1.jpg')}}" alt="" > 
                <!-- Team hover -->
          ...
          <li class="col-md-4 text-center animate fadeInUp" data-wow-delay="0.6s">
            <article> 
              <!-- abatar -->
              <div class="avatar"> <img class="img-circle" src="{{asset('shop/images/team-2.jpg')}}" alt="" > 
                <!-- Team hover -->
                <div class="team-hover">
                  <div class="position-center-center">
                    <div class="social-icons"> <a href="#."><i class="icon-social-facebook"></i></a> <a href="#."><i class="icon-social-twitter"></i></a> <a href="#."><i class="icon-social-dribbble"></i></a> </div>
    ...
    <section class="our-team padding-top-150 padding-bottom-100">
      <div class="container">
        ...
        <ul class="clients-img">
          <li> <img class="img-responsive" src="{{asset('shop/images/c-img-1.jpg')}}" alt=""> </li>
          <li> <img class="img-responsive" src="{{asset('shop/images/c-img-1.jpg')}}" alt=""> </li>
          <li> <img class="img-responsive" src="{{asset('shop/images/c-img-1.jpg')}}" alt=""> </li>
          <li> <img class="img-responsive" src="{{asset('shop/images/c-img-1.jpg')}}" alt=""> </li>
        </ul>
