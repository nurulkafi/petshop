        ...
        <div class="row">
          ...
          <div class="col-sm-3">
            <div class="shop-sidebar">
              ...
              <ul class="shop-cate">
                <li ><a href="{{ url('products/category/pet') }}"> <b>Pet</b> <span></span></a></li>
                @foreach ($petCategory as $item)
                <li><a href="{{ url('products/category/pet/'.$item->slug) }}"> {{ $item->name }} <span></span></a></li>
                @endforeach
              </ul>
            ...
            <div class="papular-block row">
              ...
              <div class="col-md-4">
                <div class="item">
                  ...
                  {{-- @else --}}
                  <div class="item-img"> <img class="img-1" src="{{asset('storage/'.$p->image->first()->small)}}" alt="" style="width: 270px;height: 352px"> <img class="img-2" src="{{asset('storage/'.$p->image->first()->small)}}" alt="" style="width: 270px;height: 352px">
                    <!-- Overlay -->
                    <div class="overlay">
                      <div class="position-center-center">
                        <div class="inn"><a href="{{asset('storage/'.$p->image->first()->small)}}" data-lighter><i class="icon-magnifier"></i></a> <a href="#."><i class="icon-basket"></i></a> <a href="#." ><i class="icon-heart"></i></a></div>
                      </div>
                    </div>
                  </div>
                  {{-- @endif --}}
