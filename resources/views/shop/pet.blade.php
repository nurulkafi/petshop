                ...
                <div class="col-xs-6">
                  <div class="pull-right">
                    ...
                    <select class="selectpicker" onchange="location = this.value;">
                      ...
                      <option value="{{ url('pets/price/asc') }}" style="font-weight: bold;">Low To High Price</option>
                      <option value="{{ url('pets/price/desc') }}" style="font-weight: bold;">High To Low Price</option>
                    </select>
                </div>
              </div>
            </div>
