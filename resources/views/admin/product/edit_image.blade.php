        ...
        <div class="row">
            ...
            <div class="col-12 col-md-6 order-md-2 order-first">
                <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                    {{ Breadcrumbs::render('edit_image_product',$id) }}
                </nav>
            </div>
        </div>
    </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <nav class="nav flex-column">
                            <a class="nav-link" href="{{ route('product.edit',$id) }}">Product Information</a>
                            <a class="nav-link active" aria-current="page" href="#"">Product Image</a>
                        </nav>
                    </div>
                </div>
            </div>
...
<div class="modal text-left" id="primary" tabindex="-1"role="dialog" aria-labelledby="myModalLabel160"aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable"
        ...
        <form method="POST" action="{{ url('product/image/'.$id)}}" id="form" enctype="multipart/form-data">
        @csrf
        <div id="method">
...
<script>
    $(document).ready(function() {
        ...
        $('.hapusData').on('click',function () {
            ...
            $('#form').attr('action','../../../product/image/' + id);
        });
        $('#closeBTN').on('click',function(){
            ...
            $('#form').attr('action','../../../product/image/' + product_id);
            $('#method').empty();
        });
    });
</script>
