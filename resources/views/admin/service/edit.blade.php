                ...
                <div class="card">
                    ...
                    <form action="{{ route('service.update',$service->id) }}" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <textarea type="text" class="form-control round" name="detail"  id="detail" value="">{{ $service->detail }}</textarea>
                        </div>
                        <div class="form-group">
                            <label for="">Fee</label>
                            <input type="text" class="form-control uang"  autocomplete="off" name="fee" value="{{ $service->fee }}">
                        </div>
                        <div class="form-group">
